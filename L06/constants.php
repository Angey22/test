...
// (Пример использования магической константы "__DIR__" для вывода на экран консоли исполняемого кода из другого файла)
require __DIR__ . '/strings.php'; // (Задаем команду на запуск файла "strings.php" с добавлением к адресу директории (который "дает" константа __DIR__) недостающего фрагмента с именем запускаемого файла)


echo __FILE__, PHP_EOL; // (Константа "__FILE__" - отобразит какой файл является текущим на данный момент)
echo __LINE__, PHP_EOL; // (Константа "__LINE__" - отобразит на какой строке кода она находится, т.е. на 41-й)
...
echo $line, PHP_EOL; // (Константа "__LINE__" - отобразит на какой строке кода она находится, т.е. на 44-й)
